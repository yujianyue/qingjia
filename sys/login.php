...
if (isset($_GET['act'])) {
    ...
    switch ($act) {
        case 'login':
            ...
            json_result(0, '登录成功', ['url' => 'sys.php?do=lius']);
            break;
...
<div class="login-container">
    <div class="login-title">系统管理员登录</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('loginBtn').addEventListener('click', function() {
            ...
            // 发送登录请求
            ajaxRequest('sys.php?do=login&act=login', formData, function(res) {
                if (res.code === 0) {
